      ...
      <Row>
            ...
            <div className="d-flex">
              {/* <Card.Body className="d-flex flex-column align-items-center">
                ...
                <Card.Title style={{ color: "green" }}>
                  <u style={{cursor: "pointer"}} onClick={() => console.log("Hello World")}>Claimed</u>
                </Card.Title>
              </Card.Body> */}
              <Card.Body className="d-flex flex-column align-items-center">
                <CircularProgressbar
        ...
        <Card>
          <Card.Body className="d-flex flex-column gap-2">
            ...
            <Button className="btn btn-primary">Approve claims</Button>
            <Button className="btn btn-primary">View your claims</Button>
          </Card.Body>
        </Card>
        </Col>
      </Row>
